...
class DDLCommandSuite extends PlanTest {
  ...
  test("alter table: storage properties") {
    ...
    val expected1 = AlterTableStorageProperties(tableIdent, BucketSpec(10, cols, Nil))
    val expected2 = AlterTableStorageProperties(tableIdent, BucketSpec(10, cols, cols))
